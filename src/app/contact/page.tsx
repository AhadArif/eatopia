    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-orange-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="text-center mb-16 pt-16">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-roboto mb-4 text-gray-900 dark:text-white">
            Contact Us
          </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-600 rounded-2xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent font-roboto text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 transition-all duration-200"
                />
              </div>

              <div>
                <label htmlFor="email" className="block text-sm font-roboto text-gray-700 dark:text-gray-300 mb-3">
                  Email Address
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-roboto text-gray-700 dark:text-gray-300 mb-3">
                  Message
                </label>
                <textarea
                  id="message"
              ...
              {status && (
                <div className={`p-4 rounded-2xl text-sm font-roboto border ${getStatusClass(status)}`}>
                  {status}
                </div>
              )}
            </form>
        ...
        <section className="mt-16 text-center">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <h3 className="text-xl font-roboto text-gray-900 dark:text-white mb-2">Email</h3>
              <p className="text-gray-600 dark:text-gray-400 font-roboto">hello@eatopia.com</p>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <h3 className="text-xl font-roboto text-gray-900 dark:text-white mb-2">Phone</h3>
              <p className="text-gray-600 dark:text-gray-400 font-roboto">+1 (555) 123-4567</p>
            </div>
